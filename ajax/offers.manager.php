...
$tools = html::ModalBtn('ajax/forms/offers.new.php','OfferManager','offer','plus','btn-success btn-xs pull-right');
...
for($i=1;$i<=24;$i++){
	...
	$IMGs[$p.$img]['src'] = $p.$tn;
	$IMGs[$p.$img]['alt'] = '';//'My first photoshop layer mask on a high end PSD template theme';
