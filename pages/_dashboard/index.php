...
foreach(['aol','hotmail','yahoo'] as $ESP){
	...
	$_tools[1]	= html::ModalBtn('pages/seeds/modules/table.zap.seed_accounts.php?modal=true&esp='.$ESP,'Accounts'.$_id,false,'group txt-color-white');
	$_tools[2]	= html::ModalBtn('pages/seeds/modules/table.zap.seed_actions.php?modal=true&esp='.$ESP,'Actions'.$_id,false,'list-ol txt-color-white');
