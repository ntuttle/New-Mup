...
$.extend(!0, $.fn.dataTable.defaults, {
    sDom: "<'dt-toolbar'<'col-xs-12 col-sm-9'f><'col-xs-12 col-sm-3'l>r>t<'dt-toolbar-footer'<'col-xs-3'i><'col-xs-9'p>>",
    oLanguage: {
        sLengthMenu: "_MENU_",
        sSearch: "",
        sInfo: "<span class='txt-color-darken'>_START_</span>-<span class='txt-color-darken'>_END_</span> of <span class='text-primary'>_TOTAL_</span>",
        sInfoEmpty: "<span class='text-danger'>0-0 of 0</span>",
    ...
    l($(b).empty().html('<ul class="pagination pagination-xs"/>').children("ul"), d)
    ...
    bootstrap: {
        fnInit: function(a, b, c) {
            ...
            $(b).append('<ul class="pagination pagination-xs"><li class="prev disabled"><a href="#">&larr; ' + d.sPrevious + '</a></li><li class="next disabled"><a href="#">' + d.sNext + " &rarr; </a></li></ul>");
            var f = $("a", b);
            $(f[0]).bind("click.DT", {
                action: "previous"
            }, e), $(f[1]).bind("click.DT", {
